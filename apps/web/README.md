# PixelMind Web Frontend

The Next.js frontend application for PixelMind - an AI-powered image generation platform.
...
```bash
docker build -f docker/Dockerfile.frontend -t PixelMind-frontend ..
```
