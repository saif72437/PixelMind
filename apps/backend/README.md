# PixelMind Backend Service

The Node.js backend service for PixelMind - an AI-powered image generation platform.
...
```bash
docker build -f docker/Dockerfile.backend -t PixelMind-backend ..
```
